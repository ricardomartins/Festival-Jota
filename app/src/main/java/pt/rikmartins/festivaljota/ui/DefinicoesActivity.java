 ...
 */
public class DefinicoesActivity extends PreferenceActivity {
	/**
	...
	private void setupSimplePreferencesScreen() {
		...
		bindPreferenceSummaryToValue(findPreference(res.getString(R.string.definicoes_chave_toque_notificacao)));
		bindPreferenceSummaryToValue(findPreference(res.getString(R.string.definicoes_chave_frequencia_sincronizacao)));
	}
